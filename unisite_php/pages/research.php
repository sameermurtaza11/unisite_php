<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        <h1 class="text-4xl font-bold text-kinpoe-blue mb-8">Research & Innovation</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
            ...
            $research_items = [
                [
                    ...
                    'img' => 'static/media/research_lab.jpg'
                ],
                [
                    ...
                    'img' => 'static/media/kinpoe_building.jpg'
                ],
                [
                    ...
                    'img' => 'static/media/paec_logo.png'
                ],
                [
                    ...
                    'img' => 'static/media/graduation.jpg'
                ],
                [
                    ...
                    'img' => 'static/media/engineering_facility.jpg'
                ],
                [
                    ...
                    'img' => 'static/media/profile_icon.png'
                ],
                [
                    ...
                    'img' => 'static/media/kinpoe_logo.png'
                ],
                [
                ...
                [
                    ...
                    'img' => 'static/media/piaes_logo.png'
                ],
                [
