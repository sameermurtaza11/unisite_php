        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-100 rounded-lg p-6 shadow flex flex-col items-center">
                ...
                <button @click="openModal({
                        ...
                        images: [
                            {img: 'static/media/chem_lab1.jpg', alt: 'Chemical Lab 1'},
                            {img: 'static/media/chem_lab2.jpg', alt: 'Chemical Lab 2'},
                            {img: 'static/media/chem_lab3.jpg', alt: 'Chemical Lab 3'},
                            {img: 'static/media/chem_lab4.jpg', alt: 'Chemical Lab 4'}
                        ]
                    })"
            ...
            <div class="bg-gray-100 rounded-lg p-6 shadow flex flex-col items-center">
                ...
                <button @click="openModal({
                        ...
                        images: [
                            {img: 'static/media/mech_lab1.jpg', alt: 'Mechanical Lab 1'},
                            {img: 'static/media/mech_lab2.jpg', alt: 'Mechanical Lab 2'},
                            {img: 'static/media/mech_lab3.jpg', alt: 'Mechanical Lab 3'},
                            {img: 'static/media/mech_lab4.jpg', alt: 'Mechanical Lab 4'}
                        ]
                    })"
                    class="mt-3 text-kinpoe-blue hover:text-kinpoe-gold font-semibold focus:outline-none">
                    Read More
            ...
            <div class="bg-gray-100 rounded-lg p-6 shadow flex flex-col items-center">
                ...
                <button @click="openModal({
                        ...
                        images: [
                            {img: 'static/media/nuclear_lab1.jpg', alt: 'Nuclear Lab 1'},
                            {img: 'static/media/nuclear_lab2.jpg', alt: 'Nuclear Lab 2'},
                            {img: 'static/media/nuclear_lab3.jpg', alt: 'Nuclear Lab 3'},
                            {img: 'static/media/nuclear_lab4.jpg', alt: 'Nuclear Lab 4'}
                        ]
                    })"
                    class="mt-3 text-kinpoe-blue hover:text-kinpoe-gold font-semibold focus:outline-none">
                    Read More
            ...
            <div class="bg-gray-100 rounded-lg p-6 shadow flex flex-col items-center">
                ...
                <button @click="openModal({
                        ...
                        images: [
                            {img: 'static/media/electronic_lab1.jpg', alt: 'Electronic Lab 1'},
                            {img: 'static/media/electronic_lab2.jpg', alt: 'Electronic Lab 2'},
                            {img: 'static/media/electronic_lab3.jpg', alt: 'Electronic Lab 3'},
                            {img: 'static/media/electronic_lab4.jpg', alt: 'Electronic Lab 4'}
                        ]
                    })"
                    class="mt-3 text-kinpoe-blue hover:text-kinpoe-gold font-semibold focus:outline-none">
                    Read More
