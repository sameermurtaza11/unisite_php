    ...
    <div class="container mx-auto px-4">
        <div class="text-center">
            ...
            <p class="text-xl text-blue-100 max-w-3xl mx-auto">
                Empowering Tomorrow's Engineers Through Specialized Programs in Power and Energy.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <a href="index.php?content_file=pages/programs.php&filter=graduate"
                class="px-6 py-2 rounded-lg font-semibold transition-all duration-300 <?= activeBtn('graduate', $filter) ?>">Masters Programs</a>
            ...
            <a href="index.php?content_file=pages/programs.php&filter=professional"
                class="px-6 py-2 rounded-lg font-semibold transition-all duration-300 <?= activeBtn('professional', $filter) ?>">Short Courses</a>
        </div>
    </div>
</section>
                        ...
                        <div class="p-8">
                            ...
                            <div class="flex space-x-4">
                                <?php if ($can_apply): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="index.php?content_file=partials/login.php"
                                            class="flex-1 bg-kinpoe-blue hover:bg-kinpoe-dark-blue text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 text-center">
                                            Apply Now
                                        </a>
                                    <?php endif; ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600">Complete the application form with all required documents and information.</p>
            </div>
            <div class="text-center">
